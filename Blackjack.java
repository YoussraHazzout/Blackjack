...
public class Blackjack {
    ...
    /*
     * Beslist of de gebruiker nog een extra kaart wilt, of wilt passen.
     */
    public static boolean isKaartOfNiet(String extraKaart)
    {
        if(extraKaart.equalsIgnoreCase("kaart") || extraKaart.equalsIgnoreCase("passen"))
        {
            return true;
        }
        return false;
